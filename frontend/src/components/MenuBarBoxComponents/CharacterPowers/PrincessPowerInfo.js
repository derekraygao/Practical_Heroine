  ...
  render() {
    ...
    return (
      ...
      <>
        ...
        <div className="power-info-character-header">Princess</div>
        ...
        <table style={{borderCollapse: 'collapse', border: 'none'}}>
          <tbody>
            ...
            <tr>
              <td style={{width: '80.5pt', border: 'solid windowtext 1.0pt', borderTop: 'none', padding: '0in 5.4pt 0in 5.4pt'}}>
              ...
              <td style={{width: '79.1pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0in 5.4pt 0in 5.4pt'}}>
              ...
              <td style={{width: '69.85pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0in 5.4pt 0in 5.4pt'}}>
              ...
              <td style={{width: '78.0pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0in 5.4pt 0in 5.4pt'}}>
              ...
              <td style={{width: '42.35pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0in 5.4pt 0in 5.4pt'}}>
              ...
              <td style={{width: '117.7pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0in 5.4pt 0in 5.4pt'}}>
            ...
            <tr>
              <td style={{width: '80.5pt', border: 'solid windowtext 1.0pt', borderTop: 'none', padding: '0in 5.4pt 0in 5.4pt'}}>
                <p style={{marginTop: '0in', marginRight: '0in', marginBottom: '0in', marginLeft: '0in', lineHeight: 'normal', fontSize: '15px', fontFamily: '"Calibri",sans-serif', textAlign: 'center'}}>Eo</p>
              </td>
              <td style={{width: '79.1pt', borderTop: 'none', borderLeft: 'none', borderBottom: 'solid windowtext 1.0pt', borderRight: 'solid windowtext 1.0pt', padding: '0in 5.4pt 0in 5.4pt'}}>
              ...
              <td style={{width: '117.7pt', borderTop: 'none', borderLeft: 'none', borderBottom: '1pt solid windowtext', borderRight: '1pt solid windowtext', padding: '0in 5.4pt', verticalAlign: 'top'}}>
                <p style={{marginTop: '0in', marginRight: '0in', marginBottom: '0in', marginLeft: '0in', lineHeight: 'normal', fontSize: '15px', fontFamily: '"Calibri",sans-serif'}}>Thanks to Eo, the Starlight Princess of the Spirit Realm, John knows the identities of all the villains and is able to view the status conditions of all players in the Powers Info Tab.</p>
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div className="power-info-princess-status-tracker-title">
        Eo's Mana Sense
      </div>
      ...
      <div className="power-info-character-text-snippets">
        ...
        <p style={{marginTop: '0in', marginRight: '0in', marginBottom: '8.0pt', marginLeft: '0in', lineHeight: '107%', fontSize: '15px', fontFamily: '"Calibri",sans-serif'}}>Noru, like most of the important male characters in the game, is enamored with the game’s lead female protagonist, Lilith (Lily) Liumen. Due to her jealousy, Serena attempts to harm Lily multiple times. Her schemes are eventually exposed, and she is condemned by everyone, including the King and Noru. She is executed for her crimes and becomes nothing more than a footnote in the history of the Enlustrian Kingdom, barely worthy of a wiki entry for minor villains.</p>
        <p style={{marginTop: '0in', marginRight: '0in', marginBottom: '8.0pt', marginLeft: '0in', lineHeight: '107%', fontSize: '15px', fontFamily: '"Calibri",sans-serif'}}>John initially suffers great depression, but he soon meets Eo, the Starlight Princess, who is mysteriously on the run from the Spirit Realm. John learns that it’s not the lack of orphaning and abuse that has led to his powerless state, but due to his extremely rare Void Soul, which means he will never naturally be able to manipulate mana.</p>
        <p style={{marginTop: '0in', marginRight: '0in', marginBottom: '8.0pt', marginLeft: '0in', lineHeight: '107%', fontSize: '15px', fontFamily: '"Calibri",sans-serif'}}>John agrees to house Eo, a disembodied soul, in his Void Soul, and in return, she grants him the Star Brooch, which allows him to channel her starlight magic and to transform into the Practical Hero(ine), Star Practical.</p>
        <p style={{marginTop: '0in', marginRight: '0in', marginBottom: '8.0pt', marginLeft: '0in', lineHeight: '107%', fontSize: '15px', fontFamily: '"Calibri",sans-serif'}}>John must fight the evil forces of the Umbras, monsters capable of using dark elemental magic, while searching for a way to reclaim his manhood and to get back home to Earth.</p>
        <p style={{marginTop: '0in', marginRight: '0in', marginBottom: '8.0pt', marginLeft: '0in', lineHeight: '107%', fontSize: '15px', fontFamily: '"Calibri",sans-serif'}}>This Practical Princess and Heroine will use all immoral tactics at her disposal – blackmail, poison, and even killing – to achieve her goals!</p>
      </div>
