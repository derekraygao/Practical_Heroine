...
exports.generateRandomPhrase = () => {
    ...
    var adjectiveInd = Math.floor(Math.random() * _ADJECTIVE_.length);
    var nounInd = Math.floor(Math.random() * _PLURALNOUN_.length);
    var verbInd = Math.floor(Math.random() * _VERB_.length);
    var adverbInd = Math.floor(Math.random() * _ADVERB_.length);
    
    var randomPhrase = _ADJECTIVE_[adjectiveInd] + _PLURALNOUN_[nounInd]
                     + _VERB_[verbInd] + _ADVERB_[adverbInd];
